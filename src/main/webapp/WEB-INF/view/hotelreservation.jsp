...
<div class="w3-bar w3-white w3-large">
  <a href="#" class="w3-bar-item w3-button w3-red w3-mobile"><img class="w3-image" src="https://honeypot-images.s3.eu-south-1.amazonaws.com/logo.png" alt="HoneyComb" style="min-width:200px" width="20" height="20"> </a>
